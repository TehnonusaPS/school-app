  ...
  <div class="p-4 pb-3 space-y-3 shrink-0">
    ...
    <div class="flex items-center justify-between">
      ...
      <div class="flex items-center gap-2">
        ...
        >
          <option
            v-for="(name, index) in INDO_MONTHS"
            :key="index"
            :value="index"
          >
            {{ name }}
        ...
        <div
          class="flex items-center border border-border rounded-lg overflow-hidden bg-background/50"
        >
          <Button
            variant="ghost"
            size="icon"
            class="size-8 rounded-none border-r border-border hover:bg-accent/50"
            @click="prevMonth"
          >

...
<template>
  ...
  >
    <SheetContent
      side="right"
      class="w-full sm:max-w-md flex flex-col h-full p-0 overflow-hidden"
    >
      <!-- Header -->
      ...
      <ScrollArea class="flex-1 min-h-0">
        <div class="px-6 py-5 space-y-6 pb-10">
          <div
            v-if="groupedUpcomingEvents.length === 0"
          ...
          >
            <!-- Date group header -->
            <span
              class="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-[4px] bg-primary/10 text-primary text-[11px] font-bold border border-primary/20 shadow-sm"
            >

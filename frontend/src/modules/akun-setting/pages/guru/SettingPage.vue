...
const form = ref({
  ...
  email: auth.user?.email || 'guru@mail.com'
})
...
<template>
  <div class="space-y-6 pb-12 text-left">
    <PageHeader
      ...
      description="Kelola informasi profil pribadi, data akademik guru, dan keamanan akun Guru Pengajar Anda"
      :actions="actions"
    />
    ...
    <div class="grid gap-6 md:grid-cols-2">
      ...
      <div class="h-full">
        <FormSection title="Informasi Identitas" description="Data detail pribadi, akademik, dan kepegawaian Guru Pengajar" :icon="SquareUserRound" class="h-full">

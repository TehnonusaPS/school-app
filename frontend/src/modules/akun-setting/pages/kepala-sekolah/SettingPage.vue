...
const form = ref({
  ...
  email: auth.user?.email || 'kepalasekolah@mail.com'
})
...
<template>
  <div class="space-y-6 pb-12 text-left">
    <PageHeader
      ...
      description="Kelola informasi profil pribadi, data kepegawaian, dan keamanan akun Kepala Sekolah Anda"
      :actions="actions"
    />
    ...
    <div class="grid gap-6 md:grid-cols-2">
      ...
      <!-- Row 1, Col 2: Identitas & Kepegawaian -->
      <div class="space-y-6">
        <!-- Identitas Pribadi -->
        <FormSection title="Informasi Identitas" description="Data detail pribadi Kepala Sekolah" :icon="SquareUserRound">
        ...
        <FormSection title="Informasi Kepegawaian" description="Detail data jabatan dan instansi tempat Anda bertugas" :icon="BriefcaseBusiness">
          <div class="grid gap-4 md:grid-cols-2">
            <FormInput v-model="form.nip" label="NIP / NUPTK" disabled />
            <FormInput v-model="form.jabatan" label="Jabatan" disabled />
            <FormInput v-model="form.unitKerja" label="Sekolah" disabled class="md:col-span-2" />
          </div>
        </FormSection>
      </div>
      ...
      <!-- Row 2, Col 2: Kontak -->
      <div class="h-full">
        <FormSection title="Kontak & Alamat" description="Informasi kontak dan tempat tinggal" :icon="Phone" class="h-full">
          <div class="grid gap-4 md:grid-cols-2">

    ...
    <div class="grid gap-6 md:grid-cols-2">
      ...
      <div class="space-y-6">
        ...
        <FormSection
          ...
          description="Data nama lengkap dan nomor identitas kependudukan orang tua"
        ...
        <FormSection
          title="Hubungan Siswa"
          description="Detail data hubungan keluarga dengan siswa (anak)"
          :icon="BriefcaseBusiness"
        >
          <div class="grid gap-4 md:grid-cols-2">
            <FormInput
              v-model="form.hubunganSiswa"
              label="Hubungan dengan Siswa"
              disabled
            />
            <FormInput
              v-model="form.namaSiswa"
              label="Nama Siswa (Anak)"
              disabled
            />
          </div>
        </FormSection>

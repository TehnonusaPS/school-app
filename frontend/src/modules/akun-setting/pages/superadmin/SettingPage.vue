...
import { Save, Phone, Image, SquareUserRound, Key } from 'lucide-vue-next'
...
const form = ref({
  ...
  email: auth.user?.email || 'superadmin@mail.com'
})
...
<template>
  <div class="space-y-6 pb-12 text-left">
    <PageHeader
      ...
      description="Kelola informasi profil pribadi dan pengaturan keamanan akun Superadmin Anda"
      :actions="actions"
    />

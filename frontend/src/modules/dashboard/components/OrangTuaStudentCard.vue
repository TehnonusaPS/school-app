...
<template>
  ...
  >
    ...
    <div class="flex flex-col justify-between p-6 bg-gradient-to-br from-primary/25 via-primary/15 to-primary/5 w-[60%] shrink-0 relative z-10 border-r border-primary/15 backdrop-blur-sm">
      <div class="space-y-1">

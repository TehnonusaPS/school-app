...
const schoolCount = computed(
  () => new Set(store.items.map(i => i.school_name).filter(Boolean)).size
)
...
const stats = computed(() => {
  if (props.isYayasan) {
    return [
      {
        label: 'Total Cabang',
        value: schoolCount.value.toLocaleString('id-ID'),
        sub: 'unit terdaftar',
        icon: School,
        variant: 'blue',
        illustration: 'globe'
      ...
      {
        label: 'Total Aset',
        value: store.items.length.toLocaleString('id-ID'),
        sub: 'seluruh cabang',
        icon: Package,
        variant: 'emerald',
        illustration: 'bag'
      },
      {
        ...
        value: layakPakai.value.toLocaleString('id-ID'),
        sub: 'kondisi baik',
        icon: CheckCircle,
        variant: 'violet',
        illustration: 'star'
      },
      {
        ...
        value: butuhPerbaikan.value.toLocaleString('id-ID'),
        sub: 'perlu tindakan',
        icon: Wrench,
        variant: 'amber',
        illustration: 'crayon'
  ...
  return [
    ...
    {
      label: 'Kondisi Baik',
      value: store.items.filter(i => i.condition === 'Baik').length.toLocaleString('id-ID'),
      sub: 'layak pakai',
      icon: CheckCircle,
      variant: 'emerald',
      illustration: 'star'
    },
    {
      label: 'Rusak Ringan',
      value: store.items
        .filter(i => i.condition === 'Rusak Ringan' || i.condition === 'Perbaikan')
    ...
    {
      label: 'Rusak Berat',
      value: store.items.filter(i => i.condition === 'Rusak Berat').length.toLocaleString('id-ID'),
      sub: 'tidak layak',
      icon: TriangleAlert,
      variant: 'rose',
      illustration: 'ruler'

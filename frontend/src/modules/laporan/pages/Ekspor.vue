...
const formatList = [
  {
    id: 'excel',
    label: 'Excel (.xlsx)',
    desc: 'Format spreadsheet Microsoft Excel',
  ...
  },
  {
    id: 'pdf',
    label: 'PDF (.pdf)',
    desc: 'Format dokumen siap cetak',
    icon: FileText,
    color: 'text-red-600',
  ...
  },
  {
    id: 'csv',
    label: 'CSV (.csv)',
    desc: 'Format data teks terpisah koma',
    icon: FileJson,
    color: 'text-blue-600',
...
const riwayatEkspor = ref([
  {
    id: 1,
    nama: 'Absensi_Mei2026.xlsx',
    ukuran: '124 KB',
    tgl: '27 Mei 2026, 14:32',
    status: 'selesai',
    format: 'excel'
  },
  {
    id: 2,
    nama: 'LaporanNilai_Sem1.pdf',
    ukuran: '892 KB',
    tgl: '20 Mei 2026, 09:15',
    status: 'selesai',
    format: 'pdf'
  },
  {
    id: 3,
    nama: 'Keuangan_Apr2026.xlsx',
    ukuran: '256 KB',
    tgl: '1 Mei 2026, 08:00',
    status: 'selesai',
    format: 'excel'
  }
])
    ...
    <div class="flex flex-col gap-4 md:flex-row md:items-start md:justify-between border-b pb-4">
      <div>
        ...
        <p class="text-muted-foreground mt-1 text-sm">
          Ekspor data laporan ke format Excel, PDF, atau CSV.
        </p>
      </div>
    </div>
    ...
    <div class="grid gap-6 lg:grid-cols-3">
      ...
      <div class="lg:col-span-2 space-y-5">
        ...
        <Card>
          <CardHeader class="pb-3">
            ...
            <CardDescription class="text-xs"
              >Centang satu atau lebih jenis data yang ingin diekspor.</CardDescription
            >
          </CardHeader>
          <CardContent>
            ...
            <div class="flex flex-col gap-3">
              ...
              <div class="flex items-center justify-between">
                <div>
                  ...
                  <p class="text-xs text-muted-foreground">
                    Tambahkan logo dan identitas sekolah pada dokumen
                  </p>
                </div>
              ...
              <div class="flex items-center justify-between">
                <div>
                  ...
                  <p class="text-xs text-muted-foreground">
                    Tambahkan visualisasi data (hanya untuk Excel & PDF)
                  </p>
                </div>
                <Switch
                  v-model:checked="includeChart"
        ...
        >
          ...
          <div
            v-else
            class="size-5 animate-spin rounded-full border-2 border-background border-t-transparent"
          />

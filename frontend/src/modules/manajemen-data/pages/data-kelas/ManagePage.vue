...
<template>
    ...
    <div class="space-y-6">
      <Card>
        <CardHeader>
          ...
          <CardDescription> Kelas tujuan penempatan siswa </CardDescription>
        </CardHeader>
        <Separator />
          ...
          <div class="flex flex-col gap-1">
            <div class="flex items-center gap-2">
              <span
                ...
                :class="item.kehadiran >= 100 ? 'text-primary' : 'text-amber-600'"
              >
                {{ item.kehadiran }}
              </span>
  ...
  <AlertDialog v-model:open="isConfirmOpen">
    <AlertDialogContent>
      <AlertDialogHeader>
        <AlertDialogTitle> Konfirmasi Penempatan Siswa </AlertDialogTitle>
      ...
      <AlertDialogFooter>
        ...
        <AlertDialogAction @click="placeStudentsToClass"> Tempatkan </AlertDialogAction>
      </AlertDialogFooter>
    </AlertDialogContent>
  </AlertDialog>
</template>

...
import { akreditasi, jenjangOptions, yayasanOptions } from './data/sekolahYayasan'
...
const handleSubmit = () => {
  ...
  setTimeout(() => {
    ...
    router.push('/manajemen-data/sekolah-yayasan')
  }, 1500)
}
</script>
  ...
  <div class="space-y-6 p-1 pb-10">
    ...
    <div class="grid gap-6 md:grid-cols-3">
      ...
      <div class="md:col-span-2 space-y-6">
        <FormSection title="Informasi Umum" description="Informasi dasar mengenai sekolah" :icon="Building2">
            <div class="grid gap-4 md:grid-cols-2">
                <FormInput v-model="form.nama" label="Nama Sekolah" placeholder="Contoh: Sekolah Cerdas Bangsa 1 Tebet"/>
                <FormInput v-model="form.npsn" label="NPSN" placeholder="Contoh: YCB001"/>
            </div>
            <div class="grid gap-4 md:grid-cols-2">
                <FormSelect v-model="form.yayasan" label="Nama Yayasan" placeholder="Pilih yayasan" :options="yayasanOptions"/>

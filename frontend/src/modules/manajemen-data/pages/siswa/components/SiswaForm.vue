<script setup>
import { Phone, Image, UserCog, SquareUserRound, GraduationCap, ShieldUser } from 'lucide-vue-next'
...
<template>
    <div class="grid gap-6 md:grid-cols-3">
      ...
      <FormSection
        title="Kontak Siswa"
        description="Informasi kontak dari siswa"
        :icon="Phone"
      >
        <FormInput
          v-model="form.email"
        ...
        <FormInput
          v-model="form.no_hp"
          label="No. Telp"
          placeholder="Contoh: 081289170180"
        />
    ...
    <div class="md:col-span-2 space-y-6">
      <FormSection
        ...
        description="Informasi dasar mengenai siswa"
      ...
      >
        ...
        <FormTextArea
          ...
          placeholder="Contoh: Nama Jalan, RT/RW, Kelurahan, Kecamatan, Kota"
        />
      </FormSection>

      <FormSection
        title="Informasi Orang Tua / Wali"
        description="Informasi dasar mengenai orang tua / wali siswa"
        :icon="ShieldUser"
      >
        <div class="grid gap-4 md:grid-cols-2">
          <FormInput
        ...
        <div class="grid gap-4 md:grid-cols-2">
          <FormInput
            v-model="form.email_wali"
            label="E-mail Wali"
            placeholder="Contoh: john.doe@sekolah.com"
          />
          <FormInput
      ...
      <FormSection
        ...
        description="Informasi akun yang digunakan orang tua/wali siswa untuk mengakses sistem."
        :icon="UserCog"
      >
        <div class="grid gap-4 md:grid-cols-2">
          <FormInput
            ...
            label="E-mail Login"
            placeholder="Contoh: nama_ortu@gmail.com"
          />
          <FormInput

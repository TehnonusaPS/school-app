    ...
    <div class="max-w-7xl mx-auto px-6 flex items-center justify-between">
      ...
      <div class="hidden lg:block">
        <a
          ...
          class="inline-block px-6 py-2.5 rounded-xl text-sm font-semibold bg-secondary text-primary shadow-lg hover:bg-secondary transition-all hover:-translate-y-0.5"
        >
      ...
      >
        <div class="flex flex-col gap-1">
          ...
          <a
            ...
            class="block mt-3 py-3 rounded-xl bg-secondary text-primary font-semibold text-center"
          >
            {{ data?.hero_cta_text || 'Daftar Sekarang' }}
          </a>
        </div>

...
const jadwal = [
  { mulai: '07:00', selesai: '08:30', mapel: 'Matematika Dasar', kelas: 'Kelas 10-A', aktif: true  },
  { mulai: '09:00', selesai: '10:30', mapel: 'Aljabar Linear',   kelas: 'Kelas 11-B', aktif: false },
  { mulai: '11:00', selesai: '12:30', mapel: 'Matematika Dasar', kelas: 'Kelas 10-B', aktif: false },
  { mulai: '13:30', selesai: '15:00', mapel: 'Statistika',       kelas: 'Kelas 12-A', aktif: false }
]
</script>
    ...
    <CardHeader class="pb-3">
      <div class="flex items-center justify-between">
        <div class="flex items-center gap-2">
          ...
          <CardTitle class="text-base font-semibold">Jadwal Mengajar Hari Ini</CardTitle>
        </div>
        <Badge variant="outline" class="text-xs font-semibold text-primary">
          {{ today }}
        </Badge>
      </div>
      <CardDescription class="text-xs">{{ jadwal.length }} sesi mengajar terjadwal hari ini</CardDescription>
    </CardHeader>

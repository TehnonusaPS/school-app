...
<template>
  <div class="space-y-6 w-full mx-auto px-0">
      ...
      <div class="grid gap-4 md:grid-cols-4 w-full">
        <Card class="p-5">
          ...
          <div class="mt-4 flex items-center justify-between gap-4">
            ...
            <div class="rounded-xl bg-slate-100 p-3 text-slate-700">🏢</div>
          </div>
        </Card>
        <Card class="p-5">
        ...
        <CardContent class="p-4">
          <div class="overflow-x-auto">
            <table class="min-w-full text-sm">
              <thead>
                <tr class="border-b bg-slate-100 text-left text-xs uppercase tracking-[0.2em] text-muted-foreground">
              ...
              <tbody>
                <tr class="border-b hover:bg-slate-50">
                  ...
                  <td class="px-4 py-4"><span class="inline-flex rounded-full bg-emerald-100 px-3 py-1 text-xs font-semibold text-emerald-700">Approve</span></td>
    ...
    <div v-if="isAdminYayasan" class="rounded-xl border bg-card p-6">
      ...
      <button class="bg-primary text-white px-4 py-2 rounded-lg text-sm font-semibold hover:bg-primary/90 transition flex items-center gap-2">
    ...
    <div v-if="isKepsek" class="space-y-6 w-full">
      <div class="flex flex-col gap-4 xl:flex-row xl:items-center xl:justify-between">
        ...
        <div class="flex flex-wrap gap-3">
          ...
          <Button class="rounded-lg bg-slate-900 text-white hover:bg-slate-800">Approve All Requests</Button>
        </div>
      </div>
      ...
      <div class="grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
        <Card class="p-6">
          ...
          <div class="mt-4 h-2 w-full overflow-hidden rounded-full bg-slate-200">
            <div class="h-full w-[84%] rounded-full bg-emerald-600"></div>
          </div>
        </Card>
        <Card class="p-6">
          ...
          <p class="text-sm text-emerald-600 mt-2">↗ 4.2% bulan ini</p>
        </Card>
        <Card class="p-6">
          ...
          <div class="mt-4 h-2 w-full overflow-hidden rounded-full bg-slate-200">
            <div class="h-full w-[65%] rounded-full bg-emerald-600"></div>
          </div>
        </Card>
        <Card class="p-6">
          ...
          <div class="mt-4 flex items-center gap-3">
            ...
            <span class="rounded-full bg-red-100 px-3 py-1 text-xs font-semibold text-red-700">Prioritas Tinggi</span>
          </div>
          ...
          <div class="space-y-4 mt-6">
            <div>
              ...
              <div class="mt-2 h-2 w-full overflow-hidden rounded-full bg-slate-200">
                <div class="h-full w-[92%] rounded-full bg-emerald-600"></div>
              </div>
            </div>
            <div>
              <div class="flex items-center justify-between text-sm font-medium text-slate-900">
              ...
              <div class="mt-2 h-2 w-full overflow-hidden rounded-full bg-slate-200">
                <div class="h-full w-[78%] rounded-full bg-slate-700"></div>
              </div>
            </div>
            <div>
              <div class="flex items-center justify-between text-sm font-medium text-slate-900">
              ...
              <div class="mt-2 h-2 w-full overflow-hidden rounded-full bg-slate-200">
                <div class="h-full w-[64%] rounded-full bg-red-600"></div>
              </div>
            </div>
          </div>
          <blockquote class="mt-6 rounded-lg border border-slate-200 bg-slate-50 p-4 text-sm italic text-slate-600">
        ...
        <Card class="p-6">
          <div class="flex items-center justify-between">
            ...
            <div class="flex items-center gap-2 text-xs text-muted-foreground">
              <span class="inline-flex h-2 w-2 rounded-full bg-slate-900"></span> Realisasi
              <span class="inline-flex h-2 w-2 rounded-full bg-slate-400"></span> Limit Anggaran
            </div>
          </div>
          <div class="mt-8 h-[22rem] rounded-3xl border border-dashed border-slate-200 bg-slate-50 text-center text-sm text-slate-500 grid place-items-center">
            Grafik placeholder
          </div>
            ...
            <table class="min-w-full text-sm">
              ...
              <tbody>
                <tr class="border-b hover:bg-slate-50">
                  ...
                  <td class="px-4 py-4"><span class="rounded-full bg-red-100 px-2 py-1 text-xs font-semibold text-red-700">Tinggi</span></td>
                  <td class="px-4 py-4 flex gap-2">
                    <Button variant="outline" size="sm" class="h-9 px-3">✖️</Button>
                    <Button class="h-9 px-3 bg-slate-900 text-white hover:bg-slate-800">Sign</Button>
                  </td>
                </tr>
                <tr class="border-b hover:bg-slate-50">
                  ...
                  <td class="px-4 py-4"><span class="rounded-full bg-slate-100 px-2 py-1 text-xs font-semibold text-slate-600">Medium</span></td>
                  <td class="px-4 py-4 flex gap-2">
                    <Button variant="outline" size="sm" class="h-9 px-3">✖️</Button>
                    <Button class="h-9 px-3 bg-slate-900 text-white hover:bg-slate-800">Sign</Button>
                  </td>
    ...
    <div v-if="isAdminSekolah" class="space-y-6">
      ...
      <div class="grid gap-4 grid-cols-[3fr_2fr]">
        ...
        <div class="grid gap-4 grid-cols-3">
          ...
          <div class="rounded-xl border bg-card p-6 hover:shadow-md transition cursor-pointer">
            <div class="bg-slate-900 text-white rounded-lg w-10 h-10 flex items-center justify-center mb-3">
          ...
          <div class="rounded-xl border bg-card p-6 hover:shadow-md transition cursor-pointer">
            <div class="bg-indigo-600 text-white rounded-lg w-10 h-10 flex items-center justify-center mb-3">
          ...
          <div class="rounded-xl border bg-card p-6 hover:shadow-md transition cursor-pointer">
            <div class="bg-slate-600 text-white rounded-lg w-10 h-10 flex items-center justify-center mb-3">
              <ClipboardList class="size-5" />
            </div>
        ...
        <div class="space-y-3">
          ...
          <div class="rounded-xl border bg-card p-4">
            ...
            <div class="flex items-baseline gap-2 mt-2">
              <h2 class="text-2xl font-bold text-red-600">12 Transaksi</h2>
      ...
      <div class="rounded-xl border bg-card p-6">
          ...
          <table class="w-full text-sm">
            ...
            <tbody>
              ...
              <tr class="border-b hover:bg-muted/50">
                <td class="px-4 py-4">
                  <div class="flex items-center gap-2">
                    <div class="bg-blue-500 text-white rounded-full w-8 h-8 flex items-center justify-center text-xs font-bold">AS</div>
                ...
                <td class="px-4 py-4"><span class="bg-blue-100 text-blue-700 px-2 py-1 rounded text-xs font-semibold">PENDING</span></td>
                <td class="px-4 py-4 flex gap-2">
                  <button class="bg-slate-900 text-white px-3 py-1 rounded text-xs font-semibold hover:bg-slate-800">Proses</button>
                  <button class="border border-slate-300 text-slate-700 px-3 py-1 rounded text-xs hover:bg-slate-50">📄</button>
                </td>
              </tr>
              <!-- Row 2 -->
              <tr class="border-b hover:bg-muted/50">
                <td class="px-4 py-4">
                  <div class="flex items-center gap-2">
                    <div class="bg-emerald-500 text-white rounded-full w-8 h-8 flex items-center justify-center text-xs font-bold">BN</div>
                ...
                <td class="px-4 py-4"><span class="bg-emerald-100 text-emerald-700 px-2 py-1 rounded text-xs font-semibold">PAID</span></td>
                <td class="px-4 py-4 flex gap-2">
                  <button class="border border-slate-300 text-slate-700 px-3 py-1 rounded text-xs hover:bg-slate-50">Selesai</button>
                  <button class="border border-slate-300 text-slate-700 px-3 py-1 rounded text-xs hover:bg-slate-50">⚙️</button>
                </td>
              </tr>
              <!-- Row 3 -->
              <tr class="border-b hover:bg-muted/50">
                <td class="px-4 py-4">
                  <div class="flex items-center gap-2">
                    <div class="bg-slate-400 text-white rounded-full w-8 h-8 flex items-center justify-center text-xs font-bold">DW</div>
                ...
                <td class="px-4 py-4">Oktober 2023</td>
                <td class="px-4 py-4">Rp 750.000</td>
                <td class="px-4 py-4"><span class="bg-red-100 text-red-700 px-2 py-1 rounded text-xs font-semibold">OVERDUE</span></td>
                <td class="px-4 py-4 flex gap-2">
                  <button class="bg-slate-900 text-white px-3 py-1 rounded text-xs font-semibold hover:bg-slate-800">Proses</button>
                  <button class="border border-slate-300 text-slate-700 px-3 py-1 rounded text-xs hover:bg-slate-50">✉️</button>
                </td>
              ...
              <tr class="border-b hover:bg-muted/50">
                <td class="px-4 py-4">
                  <div class="flex items-center gap-2">
                    <div class="bg-slate-900 text-white rounded-full w-8 h-8 flex items-center justify-center text-xs font-bold">FL</div>
        ...
        <div class="flex items-center justify-between mt-4">
          ...
          <div class="flex gap-1">
            ...
            <button class="px-2 py-1 bg-primary text-white rounded text-sm">1</button>
      ...
      <div class="grid gap-4 grid-cols-[2fr_1.5fr]">
          ...
          <div class="space-y-4">
            ...
            <div class="flex gap-3 pb-4 border-b">
              ...
              <div class="flex-1">
                ...
                <p class="text-xs font-medium text-red-600 mt-1">Rp 125.000</p>
              </div>
            </div>
            <!-- Audit Item 3 -->
        ...
        <!-- Bantuan Tata Usaha -->
        <div class="rounded-xl border-2 border-slate-900 bg-slate-900 text-white p-6">
          ...
          <button class="w-full bg-white text-slate-900 py-2 rounded-lg font-semibold hover:bg-slate-100 transition">
            Buka Pusat Bantuan
          </button>
        </div>
      </div>
    ...
    <div v-if="isTataUsaha" class="space-y-6">
      ...
      <div class="grid gap-4 grid-cols-[3fr_2fr]">
        ...
        <div class="grid gap-4 grid-cols-3">
          ...
          <!-- Card 2: Input Pengeluaran Kecil -->
          <div  @click="goToPengeluaran" class="rounded-xl border bg-card p-6 hover:shadow-md transition cursor-pointer">
            <div class="bg-indigo-600 text-white rounded-lg w-10 h-10 flex items-center justify-center mb-3">
              <ClipboardList class="size-5" />
            </div>
            <h3 class="font-semibold text-sm">Input Pengeluaran Kecil</h3>
    ...
    <div v-else-if="isGuru" class="rounded-xl border bg-card p-6">
      <div class="flex items-center gap-3 mb-4">
        <CheckCircle2 class="size-5 text-emerald-600" />
    ...
    <div v-else-if="isWaliKelas" class="rounded-xl border bg-card p-6">
      <div class="flex items-center gap-3 mb-4">
        <CheckCircle2 class="size-5 text-emerald-600" />
    ...
    <div v-else-if="isSiswa" class="space-y-3">
      ...
      <div class="grid gap-4 grid-cols-[7fr_3fr]">
        ...
        <div class="rounded-xl border-l-4 border border-gray-800 bg-gray-900 p-6 flex flex-col justify-between">
          <div>
            <p class="text-xs font-semibold text-gray-400 uppercase tracking-wide">Next Payment Due</p>
            <h2 class="text-3xl font-bold text-white mt-3">15 Oktober 2023</h2>
          </div>
          <button class="mt-6 w-full bg-white text-gray-900 px-4 py-2 rounded-lg text-sm font-semibold hover:bg-gray-100 transition flex items-center justify-center gap-2">
      ...
      <div class="grid gap-4 grid-cols-[7fr_3fr]">
          ...
          <div class="space-y-3">
            ...
            <div class="space-y-2 max-h-[15rem] overflow-y-auto">
              <div class="grid grid-cols-12 gap-3 px-4 py-3 rounded-lg bg-muted hover:bg-muted/80">
                ...
                <div class="col-span-3"><span class="text-xs font-semibold bg-red-100 text-red-700 px-2 py-1 rounded">Unpaid</span></div>
              </div>
              <div class="grid grid-cols-12 gap-3 px-4 py-3 rounded-lg bg-muted hover:bg-muted/80">
                ...
                <div class="col-span-3"><span class="text-xs font-semibold bg-blue-100 text-blue-700 px-2 py-1 rounded">Partial</span></div>
              </div>
              <div class="grid grid-cols-12 gap-3 px-4 py-3 rounded-lg bg-muted hover:bg-muted/80">
                ...
                <div class="col-span-3"><span class="text-xs font-semibold bg-green-100 text-green-700 px-2 py-1 rounded">Paid</span></div>
              </div>
              <div class="grid grid-cols-12 gap-3 px-4 py-3 rounded-lg bg-muted hover:bg-muted/80">
        ...
        <div class="rounded-xl border bg-card p-6 h-[30rem] flex flex-col">
          ...
          <div class="space-y-3 overflow-y-auto flex-1 pr-2">
            <div class="rounded-lg bg-muted p-3 text-sm">
              <div class="flex items-center justify-between font-medium mb-1">
                ...
                <span class="text-emerald-600">-Rp 1.500k</span>
              </div>
            ...
            <div class="rounded-lg bg-muted p-3 text-sm">
              <div class="flex items-center justify-between font-medium mb-1">
                ...
                <span class="text-emerald-600">-Rp 350k</span>
              </div>
            ...
            <div class="rounded-lg bg-muted p-3 text-sm">
              <div class="flex items-center justify-between font-medium mb-1">
                ...
                <span class="text-emerald-600">-Rp 450k</span>
              </div>
          ...
          <button class="mt-auto w-full border border-slate-300 text-slate-700 rounded-lg py-2 text-sm font-semibold hover:bg-slate-50 transition">
      ...
      <div class="rounded-xl border bg-card p-6">
        <div class="flex items-center justify-between">
          ...
          <div class="flex gap-3">
            <button class="px-4 py-2 rounded-lg border border-slate-300 text-sm font-semibold hover:bg-slate-50">
              Panduan Pembayaran
            </button>
    ...
    <div v-else-if="isOrangTua" class="space-y-6">
      ...
      <div class="grid gap-6 lg:grid-cols-[1.5fr_1fr]">
        ...
        <Card class="p-6">
          ...
          <!-- Payment Alert -->
          <div class="mt-6 rounded-lg bg-red-50 border border-red-200 p-4 flex gap-3">
            <span class="text-lg">⚠️</span>
            <p class="text-sm font-medium text-red-800">Payment due in 4 days (October 15, 2023)</p>
          </div>
        </Card>
        ...
        <Card class="p-6">
          ...
          <div class="space-y-3 mb-6 pb-6 border-b">
            <div class="flex items-center gap-3">
              <input type="checkbox" id="spp" checked class="w-5 h-5 rounded border-slate-300" />
            ...
            <div class="flex items-center gap-3">
              <input type="checkbox" id="lab" checked class="w-5 h-5 rounded border-slate-300" />
          ...
          <div class="mb-6">
            ...
            <div class="grid grid-cols-2 gap-2 mb-4">
              <button class="border-2 border-slate-300 rounded-lg py-2 text-sm font-medium hover:border-primary hover:bg-primary/5 transition">
                BCA
              </button>
              <button class="border-2 border-slate-300 rounded-lg py-2 text-sm font-medium hover:border-primary hover:bg-primary/5 transition">
                Mandiri
            ...
            <button class="w-full border-2 border-slate-300 rounded-lg py-3 text-sm font-medium flex items-center justify-between px-4 hover:border-primary hover:bg-primary/5 transition">
              <div class="flex items-center gap-2">
                <span>💳</span>
          ...
          <Button class="w-full bg-slate-900 text-white hover:bg-slate-800 py-6 font-semibold text-base">
      ...
      <Card class="p-6">
        ...
        <div class="mt-6 text-center">
          <button class="text-sm font-medium text-slate-700 hover:text-primary">
            View All History
          </button>
        </div>
      </Card>
      ...
      <!-- Security Notice -->
      <div class="flex items-center gap-3 text-xs text-muted-foreground px-4 py-3 bg-slate-50 rounded-lg">
        <span>🔒</span>
